...
def startWindow():
    TomsCode.start_Field()

def fieldsWindow():
    TomsCode.create_Field()

def endWindow():
    TomsCode.End_window()

def packetInfoWindow():
    TomsCode.packet_info()
...
class Field:
    def __init__(self, top=None):
        ...
        self.startButton = Button(top, command=startWindow)
        ...
        self.byte2Button = Button(top, command=fieldsWindow)
        ...
        self.byte8Button = Button(top, command=fieldsWindow)
        ...
        self.byte82Button = Button(top, command=fieldsWindow)
        ...
        self.varSizeButton = Button(top, command=fieldsWindow)
        ...
        self.referenceButton = Button(top, command=refWindow)
        ...
        self.byte1Button = Button(top, command=fieldsWindow)
        ...
        self.byte4Button = Button(top, command = fieldsWindow)
        ...
        self.byte16Button = Button(top, command = fieldsWindow)
        ...
        self.byte162Button = Button(top, command = fieldsWindow)
        ...
        self.endButton = Button(top, command = endWindow)
        ...
        self.pInfoButton = Button(top, command= packetInfoWindow)
